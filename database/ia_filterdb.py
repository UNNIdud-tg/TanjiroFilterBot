...
from info import FIRSTDB_URI, DATABASE_NAME, COLLECTION_NAME, USE_CAPTION_FILTER, MAX_B_TN, SECONDDB_URI
...
#primary db
client = AsyncIOMotorClient(FIRSTDB_URI)
...
async def choose_mediaDB():
    ...
    global saveMedia
    if tempDict['indexDB'] == FIRSTDB_URI:
